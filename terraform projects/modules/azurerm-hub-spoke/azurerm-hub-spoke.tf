...
locals {
  ...
  pip_objects_pre = [for a, b in range(local.pip_count) : {
      name = a == 1 && !can(local.tp_object.hub_object.network.vpn.pip_name) ? replace(local.gateway_base_name, "gw", "gw-pip") : a == 1 && local.tp_object.hub_object.network.vpn.pip_name != null ? local.tp_object.hub_object.network.vpn.pip_name : a == 1 ? replace(local.gateway_base_name, "gw", "gw-pip") : a == 0 && !can(local.tp_object.hub_object.network.vpn.pip_name) && local.gw_object != {} ? replace(local.gateway_base_name, "gw", "gw-pip") : a == 0 && local.tp_object.hub_object.network.vpn.pip_name != null ? local.tp_object.hub_object.network.vpn.pip_name : a == 0 && local.tp_object.hub_object.network.vpn.pip_name == null && local.pip_count < 2 ? replace(local.gateway_base_name, "gw", "gw-pip") : a == 0 && !can(local.tp_object.hub_object.network.firewall.pip_name) ? replace(local.gateway_base_name, "gw", "fw-pip") : a == 0 && local.tp_object.hub_object.network.firewall.pip_name != null ? local.tp_object.hub_object.network.firewall.pip_name : replace(local.gateway_base_name, "gw", "fw-pip")
