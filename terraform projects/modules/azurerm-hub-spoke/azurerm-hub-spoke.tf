...
locals {
  ...
  vnet_objects_pre = [for a, b in range(local.rg_count) : {
    name = a == local.rg_count -1 && local.tp_object.hub_object.network == null ? replace(local.vnet_base_name, "hub", "-hub") : a == local.rg_count -1 && local.tp_object.hub_object.network.vnet_name != null ? replace(local.vnet_base_name, "hub", "-hub") : a == local.rg_count -1 && local.tp_object.hub_object.network.vnet_name == null ? local.vnet_base_name : a != local.rg_count - 1 && local.tp_object.spoke_objects[a].network == null ? replace(local.vnet_base_name, "hub", "-spoke${a + 1}") : a != local.rg_count - 1 && local.tp_object.spoke_objects[a].network.vnet_name != null ? local.tp_object.spoke_objects[a].network.vnet_name : replace(local.vnet_base_name, "hub", "-spoke${a + 1}")
