...
locals {
  ...
  rg_object = var.rg_name == null && can({ name = split("/", var.rg_id)[4], create_rg = false }) ? { name = split("/", var.rg_id)[4], create_rg = false } : var.rg_name != null ? {name = var.rg_name, create_rg = true} : {name = var.rg_name, create_rg = false}
