...
locals {
  ...
  subnet_creation_count = var.subnet_objects != null && var.create_bastion ? 2 : var.subnet_bastion_resource_id == null && var.create_bastion && var.subnet_resource_id == null || var.subnet_objects != null ? 1 : 0
