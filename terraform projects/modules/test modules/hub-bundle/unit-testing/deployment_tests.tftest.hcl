...
run "test_2_simple_deployment_with_vpn_plan" {
  command = plan
...
run "test_3_simple_deployment_with_firewall_plan" {
  command = plan
...
run "test_4_advanced_deployment_with_all_custom_values_plan" {
  command = plan

  plan_options {
    target = [module.deployment_4_advanced_with_all_custom_values_plan]
  }
}

run "test_5_advanced_deployment_with_all_custom_values_plan" {
  command = plan
