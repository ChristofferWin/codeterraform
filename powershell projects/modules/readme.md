...
|----------|----------|----------|----------|----------|----------|
| Get-AzVMSku | 3.0.2 | Acquire all needed information to deploy Azure VMs using an IaC tool by supplying very simple and little information. | <a href="https://www.powershellgallery.com/packages/Get-AzVMSku/3.0.2">PSGallery</a> | <a href="https://github.com/ChristofferWin/codeterraform/tree/main/powershell%20projects/modules/Get-AzVMSku/Get-AzVMSku.psm1">Scriptfile<a/> | <a href="https://github.com/ChristofferWin/codeterraform/tree/main/powershell%20projects/modules/Get-AzVMSku/Examples.md">Examples</a>
