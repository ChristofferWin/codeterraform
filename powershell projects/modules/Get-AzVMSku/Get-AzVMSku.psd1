#
# Module manifest for module 'AzVMSku'
#
...
@{
    ...
    GUID = '1a8b50ad-0681-4b6f-b11c-bd99967eddcb'
    ...
    FunctionsToExport = @("Get-AzVMSku", "Set-AzVMSku")
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @("Azure", "ARM", "ResourceManager", "IaC", "Automation", "VmImage", "Image", "Az")
            ...
            ReleaseNotes = 'With version 3.1.0 vm size & vm quota data has been merged in the output and overall made more useful to analyze current quotas in a given active subscription and region. Also added a new param to search through available publishers'
