...
@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'With major version 3.0.0, you can now dynamically retrieve information about any Azure image publisher — over 2,500 vendors supported. For automation scenarios, use the -NoInteractive switch.'
